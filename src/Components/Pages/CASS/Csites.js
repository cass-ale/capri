    ...
    return(
        ...
        <Slide index={0}>
            ...
            <p>The Official Website For CAPRI Media Entertainment. Coded From Scratch Using React.Js, This Website Is Able To Smoothly Transition Between Devices To Present A Modern And Responsive Experience To Users.
                 ...
                 Github Repository For The Source Code Is Private At The Moment, So Please Reach Out To View The Code Via Email. Click The Button Below To Visit This Site!</p>
            </Slide>
        <Slide index={1}>
            ...
            <p>The Official Website For Up And Coming Hip-Hop/R&B Artist, simpcxty. Born And Raised In Bessemer, AL, simpcxty Aims To Challenge Outdated Notions Of Masculinity And
                ...
                The Site Is Also High-Performing And Responsive To Capture The Eyes Of Potential Fans Whether They Be On Desktop Or Mobile. Github Repository For The Source Code Is Private At The Moment, So Please Reach Out To View The Code Via Email. Click The Button Below To Visit This Site! </p>
            </Slide>
        </Slider>
        </CarouselProvider>
        </>
