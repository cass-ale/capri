...
function Cpopup(props) {
    ...
    return(
        <div className='popup' onClick={handleClick} data-tooltip-id='closepop' data-tooltip-content="Click To Close PopUp Message.">
            ...
            <p>I sincerely hope you enjoy what you see. I am but an email away if you need to reach me. This message will close in 30 seconds, or you can click anywhere in this box to close the popup.</p>
